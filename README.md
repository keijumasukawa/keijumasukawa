...
I build apps every day as a way to learn and explore new tech.
Working across the stack with TypeScript / JavaScript, I use AI tools like Claude Code to keep picking up new technologies.

## 🛠️ Projects

### [video-sharing-app](https://github.com/keijumasukawa/video-sharing-app) &nbsp;·&nbsp; [🔗 Visit site](https://video-sharing-app-sand.vercel.app)

A video-sharing app for uploading and playing videos.<br />
Sign in to post and manage videos.
...
🚧 (Work in progress)<br />
A Pac-Man-style maze game.<br />
Ghost AI, rankings, and more are planned.
...
🚧 (Work in progress)<br />
A video-meeting app you can start just by sharing a URL.<br />
Video calls, screen sharing, chat, and more are planned.
